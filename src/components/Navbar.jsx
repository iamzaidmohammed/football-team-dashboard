...
const Navbar = () => {
  const linkClass = ({ isActive }) =>
    isActive
      ? "py-2 px-4 bg-blue-500 text-white text-xs lg:text-lg hover:bg-blue-500"
      : "py-2 px-4 text-xs lg:text-lg hover:bg-blue-500";
  return (
    <nav className="sticky top-0 z-50 bg-white shadow-sm py-5">
      <div className="max-w-7xl flex items-center md:px-5 lg:px-16 xl:mx-auto">
        ...
        <div>
          ...
          <NavLink to="/assists" className={linkClass}>
            Assists
          </NavLink>
        </div>
      </div>
